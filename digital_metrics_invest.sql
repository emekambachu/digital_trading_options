...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Oct 16, 2020 at 01:14 PM
...
(1, 'Starter / Regular Funding', 2000, 20000, NULL, NULL, NULL, NULL, NULL, 'Build an emergency fund so you can weather any storm. We recommend this for every client, because life happens.', ' ROI: 15% Monthly', NULL, 1, NULL, NULL),
(2, 'Structured Funding', 21000, 99000, NULL, NULL, NULL, NULL, NULL, 'Helps investors lower risk; whether you’re saving for a purchase, short-term goal or a payment plan. This plan will help you achieve it Faster', ' ROI: 25% monthly', ' Compound ROI: 35% monthl', 1, NULL, NULL),
(3, 'Retirement Funding', 100000, NULL, NULL, NULL, NULL, NULL, NULL, 'Start on the path of financial freedom. It may seem far away, but starting sooner makes it easier to get the retirement lifestyle you want.\r\n            (You can make daily/weekly/Monthly deposits till you get to the minimum investment)\r\n            ', '  ROI: 45% Monthly', ' Compound ROI: 55% Monthly', 1, NULL, NULL),
(4, 'Custom', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Feel free to tell us the structure of investment you desire and we fix you into a custom plan that suits your demand\r\n            ', 'ROI: Varies', NULL, 1, NULL, NULL),
(5, 'Fundamentals', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Simple and advanced non-farm payroll takes place once a month and the ROI is paid out after Three days of the trade. \r\n            ', '  ROI: ranges between 300%-500%', NULL, 1, NULL, NULL);
