...
<!-- Mirrored from demo.themewinter.com/html/bizipress/blue/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 18 Oct 2020 10:55:09 GMT -->
<head>
    <!--
     Basic Page Needs
     ==================================================
     -->
    <meta charset="utf-8">
    <title>Home 3 - BiziPress HTML5 Template</title>
    <!--
            ...
            <div class="row">
                <div class="col-lg-6 about-desc">
                    ...
                    <div class="ceo-signature">
                        <div class="ceo-desc">
                            <img class="img-fluid" src="images/pages/profile_image.png" alt="">
                        ...
                        <!-- Desc End-->
                        <img class="img-fluid" src="images/pages/sign.png" alt="">
                    </div>
                    <!-- Signature End-->
                </div>
                <!-- Col end-->
                <div class="col-lg-6 text-md-center mrt-40">
                    <img class="img-fluid" src="images/pages/work_circle.png" alt="">
                </div>
                <!-- Col end-->
            </div>
            <!-- Main row end-->
            ...
            <div class="row">
                <div class="col-lg-6 col-md-12">
                    <div class="intro-video">
                        <img class="img-fluid" src="images/intro-video.jpg" alt="">
                    ...
                    <div class="latest-post post-large">
                        <div class="latest-post-media">
                            <a class="latest-post-img" href="#">
                                <img class="img-fluid" src="images/news/news1.jpg" alt="img">
            ...
            <div class="row">
                <div class="col-sm-12 owl-carousel owl-theme text-center partners" id="partners-carousel">
                    <figure class="item partner-logo">
                        <a href="#">
                            <img class="img-fluid" src="images/clients/client1.png" alt="">
                        </a>
                    </figure>
                    <figure class="item partner-logo">
                        <a href="#">
                            <img class="img-fluid" src="images/clients/client2.png" alt="">
                        </a>
                    </figure>
                    <figure class="item partner-logo">
                        <a href="#">
                            <img class="img-fluid" src="images/clients/client3.png" alt="">
                        </a>
                    </figure>
                    <figure class="item partner-logo">
                        <a href="#">
                            <img class="img-fluid" src="images/clients/client4.png" alt="">
                        </a>
                    </figure>
                    <figure class="item partner-logo">
                        <a href="#">
                            <img class="img-fluid" src="images/clients/client5.png" alt="">
                        </a>
                    </figure>
                    <figure class="item partner-logo last">
                        <a href="#">
                            <img class="img-fluid" src="images/clients/client6.png" alt="">
                        </a>
                    </figure>
                    <figure class="item partner-logo last">
                        <a href="#">
                            <img class="img-fluid" src="images/clients/client7.png" alt="">
                        </a>
                    </figure>
                </div>
                <!-- Owl carousel end-->
